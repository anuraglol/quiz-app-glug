/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 6501bf4dd73287706949e7057a6ba69c)
// Runtime types generated with workerd@1.20260205.0 2026-02-05 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
	}
	interface ProductionEnv {
		BETTER_AUTH_URL: "https://server.imanuraglol.workers.dev";
		CLIENT_URL: "https://quiz-app-glug-client.vercel.app";
		ENVIRONMENT: "prod";
		DATABASE_URL: string;
		BETTER_AUTH_SECRET: string;
		GOOGLE_CLIENT_ID: string;
		GOOGLE_CLIENT_SECRET: string;
		PUBIC_APP_URI: string;
	}
	interface Env {
		DATABASE_URL: string;
		BETTER_AUTH_SECRET: string;
		...
		GOOGLE_CLIENT_SECRET: string;
		PUBIC_APP_URI: string;
		BETTER_AUTH_URL: "https://server.imanuraglol.workers.dev" | "http://localhost:8787";
		CLIENT_URL: "https://quiz-app-glug-client.vercel.app" | "http://localhost:3000";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_URL" | "CLIENT_URL" | "ENVIRONMENT" | "DATABASE_URL" | "BETTER_AUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "PUBIC_APP_URI">> {}
}
